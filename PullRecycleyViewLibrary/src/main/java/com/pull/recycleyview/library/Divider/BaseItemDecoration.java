package com.pull.recycleyview.library.Divider;
...
public class BaseItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public BaseItemDecoration(Context mContext, int res) {
        ...
        this.mHeight = mDivider.getIntrinsicHeight() <= 0 ? dp2px(10) : mDivider.getIntrinsicHeight();
        this.mWidth = mDivider.getIntrinsicWidth() <= 0 ? dp2px(10) : mDivider.getIntrinsicWidth();
    }
